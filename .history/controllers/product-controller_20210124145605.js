...
const GetProductDetailsByName = (request, response) => {
    try {
        ...
        const book = books.filter( (o) => {
            console.log(String(query_title));
            console.log(String(String(o.title)));
            // console.log(String(o.title).includes(String(query_title)));
            return String(o.title).includes(query_title)
        });
